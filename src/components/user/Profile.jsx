      ...
      <div className="p-8 max-w-4xl mx-auto">
        <div className="flex flex-col lg:flex-row lg:items-center lg:gap-8">
          ...
          <div className="mt-6 lg:mt-0 lg:flex-1">
            <h2 className="bg-gray-50 text-3xl font-medium text-neutral-800">
              {userData.name}
            </h2>
            ...
            <table className="w-full text-left mt-2">
              <tbody>
                ...
                <tr>
                  ...
                  <td>{userData?.address || 'no data'}</td>
                </tr>
              </tbody>
            </table>
            ...
            <table className="w-full text-left mt-2">
              <tbody>
                <tr>
                  ...
                  <td>{userData?.gender || 'no data'}</td>
                </tr>
                <tr>
                  <th className="pr-4">DOB:</th>
                  <td>{userData?.dob || 'no data'}</td>
                </tr>
              </tbody>
            </table>
            ...
            <div className="mt-6 flex gap-4">
              <button
                onClick={handleEdit}
                className="border border-primary px-6 py-2 rounded-full hover:bg-primary hover:text-gray-900 hover:bg-gray-400"
              >
                Edit
              </button>
